      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl items-center justify-center px-6 py-6">
          <a
            ...
            className="group inline-flex items-center gap-3 rounded-full border border-white/20 px-5 py-2.5 text-sm font-medium text-white transition-all hover:border-[#015B67] hover:bg-[#015B67]/15 hover:text-[#7fd4dd]"
          >
            <svg
              className="h-5 w-5 transition-colors group-hover:text-[#7fd4dd]"
              viewBox="0 0 24 24"
              fill="currentColor"
